const guaraniResources = {
    name: "Guaraní",
    nativeName: "Avañe'ẽ",
    flag: "🇵🇾",
    learners: "500K+",
    speakers: "7M+ (native + second language)",
    highlights: [
        "200+ distinct resources across Paraguay, Argentina, Bolivia, and Brazil",
        "Maitei Platform: Gamified university learning funded by CONACYT",
        "Official co-official status in Paraguay and Argentina's Corrientes province",
        "Duolingo course: Free gamified learning with full mobile compatibility",
        "Strong government support through Paraguay's Secretaría de Políticas Lingüísticas"
    ],
    resources: {
        courses: [
            {
        ...
        practice: [
            {
                category: "Indigenous Community Resources",
                items: [
                    {
