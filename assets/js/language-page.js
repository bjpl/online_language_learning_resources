...
(function() {
    ...
    function renderResources(filter = 'all') {
        ...
        const comprehensiveLanguages = ['dutch', 'danish', 'portuguese', 'italian', 'indonesian', 'korean', 'hindi', 'swahili', 'japanese', 'swedish', 'finnish', 'polish', 'vietnamese', 'wolof', 'tamil', 'bengali', 'kazakh', 'greek', 'latvian', 'marathi', 'persian', 'mongolian', 'navajo', 'pashto', 'ukrainian', 'signLanguage', 'irish', 'yoruba', 'slovak', 'afrikaans', 'arabic', 'bulgarian', 'burmese', 'estonian', 'french', 'german', 'malay', 'romanian', 'russian', 'serbian', 'spanish', 'tagalog', 'thai', 'lithuanian'];
